...
public class read_gfp {

	public static int locks = 0;
	 public static void main(String[] args) throws FileNotFoundException{
		//Lock down all files here except USB
 		 Process p; 
		 try {
		 p = Runtime.getRuntime().exec(String.format("xinput --disable 6"));
			} 
			catch (IOException ioe) {
			ioe.printStackTrace();
			}

File f = new File("/media/pi/C2D9-E085/Random Constructions.csv");
do {
if(f.exists()){
System.out.print("File exists");
		 ...
		 if (locks == 3){
			Process p1;
 try {
			  p1 = Runtime.getRuntime().exec(String.format("xinput --enable 9"));
		 }
catch (IOException ioe) {
			ioe.printStackTrace();
			}
...
System.out.print("No file is found. Please insert fluorescence medium to proceed. \n");
try{
...
return;
 ...
 try {
System.out.print("You've been locked out. Please refer to security \n");
...
TimeUnit.SECONDS.sleep(10);
	...
	public static void read_gfpfile(String look_for) throws FileNotFoundException{
	     ...
	     //	 Scanner scanner = new Scanner(new File("/home/pi/Random Constructions.csv"));

	         Scanner scanner = new Scanner(new File("/media/pi/C2D9-E085/Random Constructions.csv"));
